...
function EditChallenge() {
    ...
    const [challengeStartDate, setChallengeStartDate] = useState<Dayjs | undefined>(
        undefined
    );
    const [challengeEndDate, setChallengeEndDate] = useState<Dayjs | undefined>(undefined);
            ...
            >
                ...
                >
                    <DateTimePicker
                        ...
                        onChange={(newValue) => setChallengeStartDate(newValue || undefined)}
                    />
                    <DateTimePicker
                        label="Fin *"
                        ampm={false}
                        ...
                        onChange={(newValue) => setChallengeEndDate(newValue || undefined)}
